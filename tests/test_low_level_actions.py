...
def test_get_application(api_key: Dict[str, str],
                         simple_application: Dict[str, Any]):
    print()
...
@pytest.mark.interactive
def test_get_access_token(application_with_auth: Tuple[Dict[str, Any], str, str],
                          token_url: str,
                          api_key: Dict[str, str]):
    print()
...
@pytest.mark.slow_service
def test_get_all_service_jobs_for_service(service_info: Tuple[Dict[str, Any], Dict[str, Any]],
                                          api_key: Dict[str, str]):
    print()
...
@pytest.mark.interactive
def test_trigger_application_job_train(full_application: Tuple[Dict[str, Any], Dict[str, Any], str, str],
                                       api_key: Dict[str, str],
                                       token_url: str,
...
def test_trigger_application_job_predict(full_application: Tuple[Dict[str, Any], Dict[str, Any], str, str],
                                         api_key: Dict[str, str],
                                         token_url: str,
                                         train_data: Dict[str, list],
                                         train_params: Dict[str, str],
...
@pytest.mark.slow_service
def test_trigger_service_job_data_upload_train(service_info: Tuple[Dict[str, Any], Dict[str, Any]],
