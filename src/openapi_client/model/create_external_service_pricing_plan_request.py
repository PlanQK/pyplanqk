...
def lazy_import():
    ...
    globals()['CreateProductRequest'] = CreateProductRequest


class CreateExternalServicePricingPlanRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'products': ([CreateProductRequest],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """CreateExternalServicePricingPlanRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            products ([CreateProductRequest]): [optional]  # noqa: E501
        """
